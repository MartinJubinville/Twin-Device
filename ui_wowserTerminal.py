...
class Ui_wowserTerminal(object):
    def setupUi(self, wowserTerminal):
        ...
        self.actionLoadPreviousSettings = QAction(wowserTerminal)
        self.actionLoadPreviousSettings.setObjectName(u"actionLoadPreviousSettings")
        icon4 = QIcon()
        icon4.addFile(u"stuffserial/previous.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionLoadPreviousSettings.setIcon(icon4)
        self.actionLoadPreviousSettings.setMenuRole(QAction.NoRole)
        ...
        self.toolBar.addAction(self.actionLoadPreviousSettings)
...
#endif // QT_CONFIG(tooltip)
        self.actionLoadPreviousSettings.setText(QCoreApplication.translate("wowserTerminal", u"LoadPreviousSettings", None))
#if QT_CONFIG(tooltip)
        self.actionLoadPreviousSettings.setToolTip(QCoreApplication.translate("wowserTerminal", u"Load previous settings...", None))
#endif // QT_CONFIG(tooltip)
