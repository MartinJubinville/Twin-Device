...
class wowserSerialSettings():                              # replaces "Settings" in settingsdialog.py

    def __init__(self):
        self.name = "WowSer Default" 
        self.baud_rate = 2_000_000
        self.string_baud_rate = "2,000,000"
        self.data_bits = QSerialPort.Data8
        self.string_data_bits = "8 Bits"
        self.parity = QSerialPort.NoParity
        self.string_parity = "No Parity"
        self.stop_bits = QSerialPort.OneStop
        self.string_stop_bits = "One Stop Bit"
        self.flow_control = QSerialPort.SoftwareControl
        self.string_flow_control = "Software"
        self.local_echo_enabled = False                    # double check if used later
...
class wowserSettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.m_currentSettings = wowserSerialSettings()    # initialized
